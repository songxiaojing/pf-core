 ...
 * AbstractMetricMBean.
 * 
 * This class supplies common methods, delegates all methods of the DynamicBean.
 * 
 * @title AbstractMetricMBean
 * @package com.byw.dalek.platform.core.metrics
 * @author baiyanwei
 * @version
 * @date Feb 18, 2015
 * 
...
public abstract class AbstractMetricMBean implements DynamicMBean {
    ...
    private static final PlatformLogger _logger = PlatformLogger.getLogger(AbstractMetricMBean.class);

    protected MBeanInfo _mBeanInfo = null;
    ...
    public void registerMBean(String jmxObjectName, IService service) {
        ...
        try {
            ...
            _logger.exception("JMX error when registering the MonitoringService to JMX", e);
        }
    }
    ...
    public void unRegisterMBean(String jmxObjectName) {
        ...
        try {
            ...
            _logger.exception("JMX error when unregistering the MonitoringService", e);
        }
    }
    ...
    /**
     * scan the class define ,and collect the Metric fields.
     */
    ...
    /**
     * scan the class define ,and collect the Metric methods.
     */
